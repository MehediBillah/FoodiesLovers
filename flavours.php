<!DOCTYPE html>
	...
	<body>
		<div id="header">        
				  ...
				  <a><img class="hidden-sm hidden-xs" src="images/flavours.jpg" style="height:50px; width:200px; float:right"></a>
				        <ul class="nav navbar-nav">
				          <li class="active"><a href="flavours.php">Flavours Home</a></li>
				          <li><a href="flavours_menu.php">Menu List</a></li>
				        </ul>
				    </div>
				  </nav>
		...
		<div id="chilis_map">
			...
			<input type="radio" name="review" value="flavours" class="hidden-xs hidden-sm hidden-md hidden-lg" checked="checked" />
			<button type="submit" class="btn btn-success">Review</button><hr>
			</form>
			<div class="map-responsive">
		    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3634.46285826767!2d88.59806301451387!3d24.36519677092944!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fbefaf340e63db%3A0x31834698c13cd54e!2sFlavours+Cafe+Lounge!5e0!3m2!1sen!2sbd!4v1460826762856" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		    </div>
		</div>
