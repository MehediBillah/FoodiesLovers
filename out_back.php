<!DOCTYPE html>
	...
	<body>
		<div id="header">        
				  ...
				  <a><img class="hidden-sm hidden-xs" src="images/out_back.jpg" style="height:50px; width:200px; float:right"></a>
				        <ul class="nav navbar-nav">
				          <li class="active"><a href="out_back.php">Outback Home</a></li>
				          <li><a href="out_back_menu.php">Menu List</a></li>
				        </ul>
				    </div>
				  </nav>
		...
		<div id="chilis_map">
			<h1>OUT BACK fast food & cafe</h1>
			<hr/>

			<form role="form" method="post" action="review.php">
			<input type="radio" name="review" value="out_back" class="hidden-xs hidden-sm hidden-md hidden-lg" checked="checked" />
			<button type="submit" class="btn btn-success">Review</button><hr>
			</form>
			<div class="map-responsive">
		    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3634.5604185697202!2d88.62540001451379!3d24.361800571062325!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fbefda41292287%3A0x5c23e3e9d2db4574!2sOutback!5e0!3m2!1sen!2sbd!4v1460830200577" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		    </div>
		</div>
