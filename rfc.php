<!DOCTYPE html>
	...
	<body>
		<div id="header">        
				  ...
				  <a><img class="hidden-sm hidden-xs" src="images/rfc.jpg" style="height:50px; width:200px; float:right"></a>
				        <ul class="nav navbar-nav">
				          <li class="active"><a href="rfc.php">RFC Home</a></li>
				          <li><a href="rfc_menu.php">Menu List</a></li>
				        </ul>
				    </div>
				  </nav>
		...
		<div id="rfc_map">
			...
			<input type="radio" name="review" value="rfc" class="hidden-xs hidden-sm hidden-md hidden-lg" checked="checked" />
			<button type="submit" class="btn btn-success">Review</button><hr>
			</form>
			<div class="map-responsive">
		    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3634.4553300068396!2d88.59804371451385!3d24.365458820919308!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0x81a7628b652ac41b!2sRFC!5e0!3m2!1sen!2sbd!4v1460571826426" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		    </div>
		</div>
		<!--Footer-->
