<!DOCTYPE html>
	...
	<body>
		<div id="header">        
				  ...
				  <a><img class="hidden-sm hidden-xs" src="images/tfc.jpg" style="height:50px; width:200px; float:right"></a>
				        <ul class="nav navbar-nav">
				          <li class="active"><a href="tfc.php">TFC Home</a></li>
				          <li><a href="tfc_menu.php">Menu List</a></li>
				        </ul>
				    </div>
				  </nav>
		...
		<div id="tfc_map">
			...
			<input type="radio" name="review" value="tfc" class="hidden-xs hidden-sm hidden-md hidden-lg" checked="checked" />
			<button type="submit" class="btn btn-success">Review</button><hr>
			</form>
			<div class="map-responsive">
		    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3634.5023412496134!2d88.6015847145138!3d24.363822370983254!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fbefaff3780ed5%3A0xdbf8658cdd0f8ce1!2sTasty+Fried+Chicken!5e0!3m2!1sen!2sbd!4v1460571071728" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		    </div>
		</div>
		<!--Footer-->
