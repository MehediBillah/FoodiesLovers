<!DOCTYPE html>
	...
	<body>
		<div id="header">    
				  ...
				  <a><img class="hidden-sm hidden-xs" src="images/orders_up.jpg" style="height:50px; width:200px; float:right"></a>
				        <ul class="nav navbar-nav">
				          <li><a href="orders_up.php">Orders Up Home</a></li>
				          <li class="active"><a href="orders_up_menu.php">Menu List</a></li>
				        </ul>
				    </div>
				  </nav>
		</div>
		...
		$sql="SELECT item_name, price, link, restaurant FROM orders_up";
