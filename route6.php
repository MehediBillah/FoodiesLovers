	...
	<body>
		<div id="header">        
				  ...
				  <a><img class="hidden-sm hidden-xs" src="images/route6.jpg" style="height:50px; width:200px; float:right"></a>
				        <ul class="nav navbar-nav">
				          <li class="active"><a href="route6.php">Route 6 Home</a></li>
				          <li><a href="route6_menu.php">Menu List</a></li>
				        </ul>
				    </div>
				  </nav>
		...
		<div id="route6_map">
			...
			<input type="radio" name="review" value="route_6" class="hidden-xs hidden-sm hidden-md hidden-lg" checked="checked" />
			<button type="submit" class="btn btn-success">Review</button><hr>
			</form>
			<div class="map-responsive">
		    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1817.2511018121484!2d88.63120440690331!3d24.36382716183772!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0x0c74094939e29784!2sRoute+6!5e0!3m2!1sen!2sbd!4v1458924740774" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		    </div>
		</div>
		<!--Footer-->
