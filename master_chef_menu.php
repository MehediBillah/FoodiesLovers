<!DOCTYPE html>
	...
	<body>
		<div id="header">    
				  ...
				  <a><img class="hidden-sm hidden-xs" src="images/master.jpg" style="height:50px; width:200px; float:right"></a>
				        <ul class="nav navbar-nav">
				          <li><a href="master_chef.php">Master Chef Bangla Home</a></li>
				          <li class="active"><a href="master_chef_menu.php">Menu List</a></li>
				        </ul>
				    </div>
				  </nav>
		</div>
		...
		$sql="SELECT item_name, price, link, restaurant FROM master_chef_bangla";
