<!DOCTYPE html>
	...
	<body>
		<div id="header">        
				  ...
				  <a><img class="hidden-sm hidden-xs" src="images/orders_up.jpg" style="height:50px; width:200px; float:right"></a>
				        <ul class="nav navbar-nav">
				          <li class="active"><a href="orders_up.php">Orders Up Home</a></li>
				          <li><a href="orders_up_menu.php">Menu List</a></li>
				        </ul>
				    </div>
				  </nav>
		...
		<div id="orders_up_map">
			<h1>Orders Up</h1>
			<hr/>
			<form role="form" method="post" action="review.php">
			<input type="radio" name="review" value="orders_up" class="hidden-xs hidden-sm hidden-md hidden-lg" checked="checked" />
			<button type="submit" class="btn btn-success">Review</button><hr>
			</form>
			<div class="map-responsive">
		    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3634.469000329895!2d88.59900711451381!3d24.364982970937895!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fbefaf3fdeb803%3A0xa3a400ff3b46195a!2sOrder&#39;s+Up!5e0!3m2!1sen!2sbd!4v1460572255083" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		    </div>
		</div>
		<!--Footer-->
