<!DOCTYPE html>
	...
	<body>
		<div id="header">        
				  ...
				  <a><img class="hidden-sm hidden-xs" src="images/master.jpg" style="height:50px; width:200px; float:right"></a>
				        <ul class="nav navbar-nav">
				          <li class="active"><a href="master_chef.php">Master Chef Bangla Home</a></li>
				          <li><a href="master_chef_menu.php">Menu List</a></li>
				        </ul>
				    </div>
				  </nav>
		...
		<div id="chilis_map">
			<h1>Master Chef Bangla</h1>
			<hr/>

			<form role="form" method="post" action="review.php">
			<input type="radio" name="review" value="master_chef_bangla" class="hidden-xs hidden-sm hidden-md hidden-lg" checked="checked" />
			<button type="submit" class="btn btn-success">Review</button><hr>
			</form>
			<div class="map-responsive">
		    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1817.1300709951418!2d88.5815382679947!3d24.372252164872116!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0xe97740900560bbe8!2z4Kau4Ka-4Ka34KeN4Kaf4Ka-4KawIOCmuOCnh-CmqyDgpqzgpr7gpoLgprLgpr4g4Kaw4KeH4Ka44KeN4Kaf4KeB4Kaw4KeH4Kao4KeN4Kaf!5e0!3m2!1sen!2sbd!4v1460828981575" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		    </div>
		</div>
