<!DOCTYPE html>
	...
	<body>
		<div id="header">    
				  ...
				  <a><img class="hidden-sm hidden-xs" src="images/flavours.jpg" style="height:50px; width:200px; float:right"></a>
				        <ul class="nav navbar-nav">
				          <li><a href="flavours.php">Flavours Home</a></li>
				          <li class="active"><a href="flavours_menu.php">Menu List</a></li>
				        </ul>
				    </div>
				  </nav>
		</div>
		...
		$sql="SELECT item_name, price, link, restaurant FROM flavours";
