<!DOCTYPE html>
	...
	<body>
		<div id="header">    
				  ...
				  <a><img class="hidden-sm hidden-xs" src="images/out_back.jpg" style="height:50px; width:200px; float:right"></a>
				        <ul class="nav navbar-nav">
				          <li><a href="out_back.php">Outback Home</a></li>
				          <li class="active"><a href="out_back_menu.php">Menu List</a></li>
				        </ul>
				    </div>
				  </nav>
		</div>
		...
		$sql="SELECT item_name, price, link, restaurant FROM out_back";
